================================================================================
 MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: SidEmulator-Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese SidEmulator-Anwendung für Sie 
...
finden, aus denen Ihre SidEmulator–Anwendung besteht.
...
SidEmulator.h
    ...
    die CSidEmulatorApp-Anwendungsklasse.

SidEmulator.cpp
    Dies ist die Hauptquelldatei der Anwendung, die die CSidEmulatorApp-
...
res\SidEmulator.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "SidEmulator.rc" 
    enthalten.
...
SidEmulatorDlg.h, SidEmulatorDlg.cpp – das Dialogfeld
    Diese Dateien enthalten Ihre CSidEmulatorDlg–Klasse. Diese Klasse 
    bestimmt das Verhalten des Hauptdialogfelds Ihrer Anwendung. Die Vorlage des 
    Dialogfelds befindet sich in der Datei "SidEmulator.rc", die in 
...
"StdAfx.h", "StdAfx.cpp"
    ...
    (PCH-Datei) mit dem Namen "SidEmulator.pch.pch2 und eine 
